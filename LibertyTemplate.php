...
class LibertyTemplate extends BaseTemplate {
                ...
                <div style="position: fixed; bottom: 10px; right: 10px;">
    					<a href="#top" class="well well-sm" onclick="$('html,body').animate({scrollTop:0},'slow');return false;">
							<span class="fa-stack fa-lg">
  								<i class="fa fa-circle fa-stack-2x" style="color:#00BCD4;"></i>
    ...
    <nav class="navbar navbar-dark">
        ...
        <ul class="nav navbar-nav">
            ...
            <li class="nav-item">
                <?=Linker::linkKnown( SpecialPage::getTitleFor( 'IframePage', null ), '<span class="fa fa-comments"></span><span class="hide-title">게시판</span>', array( 'class' => 'nav-link', 'title' => '게시판으로 이동합니다. [alt+shift+f]', 'accesskey' => 'x' ) ); ?>
            </li>
            ...
            <li class="nav-item dropdown">
                <?php echo Linker::linkKnown( Title::makeTitle( NS_HELP, '위키 문법' ), '<span class="fa fa-book"></span><span class="hide-title">도움말</span>', array( 'class' => 'nav-link dropdown-toggle dropdown-toggle-fix', 'data-toggle' => 'dropdown', ' role' => 'button', 'aria-haspopup' => 'true', 'aria-expanded' => 'false', 'title' => '위키 문법을 보여줍니다.') ); ?>
                <div class="dropdown-menu" role="menu">
                    <?=Linker::linkKnown( Title::makeTitle( NS_HELP, '위키 문법' ), '위키 문법', array( 'class' => 'dropdown-item' ) ); ?>
                    <?=Linker::linkKnown( Title::makeTitle( NS_HELP, '설명서' ), '설명서', array( 'class' => 'dropdown-item' ) ); ?>
                </div>
            </li>
        </ul>
        <?php $this->loginBox(); ?>
	    ...
	    if ( $title->getNamespace() != NS_SPECIAL ) {
            ...
            <div class="content-tools">
                <div class="btn-group" role="group" aria-label="content-tools">
                    ...
                    ?>
                    <?=Linker::linkKnown( $title, '<span class="fa fa-pencil"><span class="hide-title">&nbsp;편집</span>', array( 'class' => 'btn btn-secondary tools-btn', 'title' => '문서를 편집합니다. [alt+shift+e]', 'accesskey' => 'e' ), $editaction ); ?>
                    <?php
                        if ($companionTitle) {
                            if ($title->getNamespace() == NS_TALK || $title->getNamespace() == NS_PROJECT_TALK || $title->getNamespace() == NS_FILE_TALK || $title->getNamespace() == NS_TEMPLATE_TALK || $title->getNamespace() == NS_USER_TALK) {
                                $titlename = '<span class="fa fa-file-text"><span class="hide-title">&nbsp;본문</span>';
                            } else {
                                $titlename = '<span class="fa fa-comment"><span class="hide-title">&nbsp;토론</span>';
                            }
                    ...
                    ?>
                    <?=Linker::linkKnown( $title, '<span class="fa fa-history"><span class="hide-title">&nbsp;기록</span>', array( 'class' => 'btn btn-secondary tools-btn', 'title' => '문서의 편집 기록을 불러옵니다. [alt+shift+h]', 'accesskey' => 'h' ), array( 'action' => 'history' ) ); ?>
                    ...
                    <div class="dropdown-menu dropdown-menu-right" role="menu">
                        ...
                        <?=Linker::linkKnown( $title, '갱신', array( 'class' => 'dropdown-item', 'title' => '문서를 갱신합니다. [alt+shift+p]', 'accesskey' => 'p' ), array( 'action' => 'purge' ) ); ?>
                        <?php
